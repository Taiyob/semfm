      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login" className="px-4 py-2 text-sm font-bold text-slate-600 hover:text-slate-900">
                Sign In
            </Link>
            <Link href="/register" className="px-6 py-2.5 bg-slate-900 text-white font-bold rounded-xl text-sm hover:bg-blue-600 transition-all shadow-lg shadow-slate-950/10">
                Get Started
            </Link>
          </div>
        </div>
            ...
            <div className="px-6 py-8 space-y-6">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="flex items-center gap-4 text-lg font-bold text-slate-600 hover:text-slate-900"
                >
              ...
              <div className="pt-6 border-t border-slate-100 grid grid-cols-2 gap-4">
                ...
                <Link href="/register" onClick={() => setIsOpen(false)} className="w-full py-4 text-center font-bold text-white bg-blue-600 rounded-2xl">
                    Register
                </Link>
              </div>
            </div>
